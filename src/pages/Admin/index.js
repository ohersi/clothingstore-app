...
const Admin = ({ products, categories, fetchProducts, fetchCategories }) => {
    ...
    const deleteProduct = async (id) => {
        try {
            const response = await axios.delete(`https://ecommerce-backnd.herokuapp.com/api/v1/products/${id}`)
            fetchProducts();
    ...
    const deleteCategory = async (id) => {
        try {
            const response = await axios.delete(`https://ecommerce-backnd.herokuapp.com/api/v1/category/${id}`)
            fetchCategories();
